...
def make_demo_dataset(output_path: Path, samples_per_class: int, random_state: int) -> None:
...
def main() -> None:
    ...
    make_demo_dataset(args.output, args.samples_per_class, args.random_state)
